...
CurrenciesListItem = ({
  ...
  calculate = (
    ...
    return baseCurrencyId != currencySelectedId
      ? currencySelectedRates / baseCurrencyRates
      : 1;
  };
    ...
    <Collapse
      ...
      onToggle={() => {
        if (expanded) updateExpansion(0);
          ...
          let value = calculate(
            currency.id,
            currenciesRates[0].id,
            currency.rates,
            currenciesRates[0].rates
          );
          setOutput(value);
      ...
      style={[
        styles.currencyCollapse,
        expanded == true ? styles.collapseExpanded : null
      ]}
    >
      ...
      <CollapseHeader
        style={
          expanded == false
            ? styles.currencyExpandedHeader
            : styles.currencyNotExpandedHeader
        }
      >
